...
const messages = {
  id: {
    ...
    'catalog.emptyHelp': 'Coba kategori atau kata pencarian lainnya.', 'catalog.ask': 'Tanya tentang {name}', 'catalog.loadError': 'Katalog belum dapat dimuat.',
  ...
  en: {
    ...
    'catalog.emptyHelp': 'Try another category or search term.', 'catalog.ask': 'Ask about {name}', 'catalog.loadError': 'The catalog could not be loaded.',
